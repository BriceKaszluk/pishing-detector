...
import { Button, Typography, Box, Container, Card, CardContent, FormControlLabel, Checkbox } from "@mui/material";
...
<Typography variant="body2">
  J'accepte les{' '}
  <Typography variant="body2" component={Link} href="/termsOfUse" sx={{ color: 'blue' }}>
    conditions d'utilisation
  </Typography>{' '}
  et la{' '}
  <Typography variant="body2" component={Link} href="/privacyPolicy" sx={{ color: 'blue' }}>
